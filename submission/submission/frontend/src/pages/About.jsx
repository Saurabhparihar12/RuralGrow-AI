...
export default function About() {
  ...
  return (
    <div className="bg-clay-50 dark:bg-forest-950 text-forest-900 dark:text-clay-50 min-h-screen flex flex-col justify-between transition-colors duration-300 relative overflow-hidden">
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-6 sm:px-8 py-16 relative z-10 space-y-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {stats.map((stat, idx) => (
            <motion.div 
              ...
              className="bg-white dark:bg-[#19221F] border border-slate-200/50 dark:border-slate-800/40 p-6 rounded-2xl flex items-center space-x-4 shadow-xs"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          ...
          >
            <div className="w-full max-w-sm h-[260px] rounded-2xl overflow-hidden border border-slate-200/45 dark:border-slate-800/40 group">
              <img 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <motion.div 
            ...
            className="bg-white dark:bg-[#19221F] border border-slate-200/50 dark:border-slate-800/40 p-8 rounded-2xl space-y-4 shadow-xs"
          >
