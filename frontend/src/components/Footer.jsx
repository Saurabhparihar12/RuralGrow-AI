    ...
    <footer className="bg-forest-950 border-t border-forest-900 text-slate-400 py-16 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 pb-12 border-b border-forest-900">
          ...
          {/* Brand Info Column (8 cols width) */}
          <div className="md:col-span-8 space-y-4">
            ...
            <p className="text-xs sm:text-sm text-slate-400 leading-relaxed max-w-md">
              A review feedback composer and digital outbox created to help local farmers, handloom weavers, and homestays build a sustainable online identity and connect with digital buyers.
            </p>
          </div>

          {/* Links Column (4 cols width) */}
          <div className="md:col-span-4 space-y-4">
            <h4 className="text-[10px] font-bold uppercase tracking-widest text-clay-100">Platform Directory</h4>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between pt-8 text-[11px] text-slate-500">
          <p>© {currentYear} RuralGrow.ai. Empowering local growers in the digital market.</p>
